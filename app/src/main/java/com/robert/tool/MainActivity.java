...
public class MainActivity extends BaseActivity {
    ...
    @OnClick({R.id.img_btn, R.id.wechat_btn, R.id.js_btn, R.id.refresh_btn, R.id.zxing_btn, R.id.locate_btn, R.id.banner_btn, R.id.video_btn, R.id.vertify_btn, R.id.popu_btn})
